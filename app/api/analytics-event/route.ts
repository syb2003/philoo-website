...
const allowedEvents = new Set<SiteAnalyticsEventName>([
  "site_page_view", "homepage_maatwerk_click", "homepage_cvstudio_click", "homepage_autosourcer_click", "scout_primary_cta_click", "scout_how_it_works_click", "scout_audience_navigation", "scout_example_start", "scout_example_stage_select", "scout_example_feedback", "scout_example_detail_open", "scout_example_complete", "scout_booking_link_click", "scout_updates_click", "scout_updates_submit", "calendly_cta_click", "cvstudio_page_view", "cvstudio_demo_play", "cvstudio_demo_50", "cvstudio_demo_complete", "cvstudio_early_access_click", "cvstudio_early_access_submit", "autosourcer_page_view", "autosourcer_interest_click", "autosourcer_interest_submit", "maatwerk_demo_play", "maatwerk_demo_50", "maatwerk_demo_complete",
]);
