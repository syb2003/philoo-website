...
export default async function TemplatesPage() {
  ...
  return (
    <div className="mx-auto max-w-[920px]">
      <PageHeader description="Beheer de huisstijlen die beschikbaar zijn in CV Studio." title="Templates" />
      <section className="mt-8 rounded-[1.5rem] border border-[#DCD8FF] bg-white p-6 shadow-[0_16px_42px_rgba(49,40,126,0.06)] sm:p-7">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex gap-4">
            ...
            <div><h2 className="text-xl font-bold tracking-[-0.03em]">{cvStudioDemoConfig.templateName}</h2><p className="mt-2 text-base leading-7 text-[#626B87]">Actieve huisstijl voor deze demo.</p></div>
          </div>
