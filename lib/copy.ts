...
export const siteCopy = {
  nl: {
    ...
    hero: {
      ...
      credibility: "Live in weken. 30 dagen niet goed geld terug. Vast maandelijks tarief.",
      cta: "Plan een gratis kennismaking",
  ...
  en: {
    ...
    hero: {
      ...
      credibility: "Live in weeks. 30-day money back guarantee. Fixed monthly price.",
      cta: "Book a free intro call",
