...
export const scoutDemoCopy: Record<Language, ScoutDemoCopy> = {
  nl: {
    ...
    disclosure: "Zo werkt Scout in deze demo.",
    ...
    memoryNote: "Scout gebruikt je feedback bij het verdere zoeken binnen deze vacature.",
    composerPlaceholder: "Iemand die zelf nieuwe zakelijke klanten vindt…",
    composerLabel: "Zoekvraag in de demo",
    stages: [
      {
      ...
      },
      {
        ...
        body: "Bekijk hun ervaring en geef aan wat wel en niet past.",
      },
      {
        nav: "Geef feedback",
        eyebrow: "03 · Geef gerichte feedback",
        title: "Geef aan wat wel en niet past.",
        body: "Welke ervaring zoek je nog? En wat is minder belangrijk?",
      },
      {
        nav: "Scout zoekt verder",
        eyebrow: "04 · Scout zoekt verder",
        title: "Kandidaten na je feedback.",
        body: "Scout zoekt verder naar mensen die zelf nieuwe klanten binnenhalen.",
      },
    ],
    conversation: [
      {
    ...
    directionLabel: "Waar Scout naar zoekt",
    direction: ["Zakelijke groei", "Zelf nieuwe klanten vinden", "Klanttype nog open"],
    ...
    initialCandidate: {
      ...
      gap: "In het profiel staat niet of de kandidaat zelf nieuwe klanten vindt.",
    },
    feedbackLabel: "Feedback van jou",
    feedback: "Ik zoek iemand die zelf nieuwe klanten binnenhaalt. Ervaring met het aansturen van een team is minder belangrijk.",
    updateTitle: "Scout gebruikt dit bij het verdere zoeken",
    moreLabel: "Belangrijker",
    more: "Zelf nieuwe klanten vinden en de eerste gesprekken voeren.",
    lessLabel: "Minder belangrijk",
    less: "Een team aansturen en bestaande klanten uitbreiden.",
    refinedCandidate: {
      name: "Kandidaat 02",
      role: "Commercieel specialist",
      location: "Regio Rotterdam",
      reasonLabel: "Waarom in deze selectie",
      reason: "In het profiel staat ervaring die aansluit op je feedback.",
      experienceLabel: "Relevante ervaring",
      experience: [
      ...
      nextLabel: "Jij kiest",
      next: "Je bepaalt zelf welke kandidaten je wilt benaderen.",
    },
    staticFallbackTitle: "Zo werkt Scout zonder animatie",
    home: {
      previewLabel: "Interactieve demo",
      messageLabel: "Scout",
    ...
    faqTitle: "Veelgestelde vragen over Scout",
    faqIntro: "Lees wat je invoert, wat Scout met je feedback doet en wat je zelf beslist.",
    faq: [
      {
      ...
      },
      {
        ...
        answer: "Ja. Geef binnen een zoekopdracht aan wat wel en niet past. Scout gebruikt die feedback bij het verdere zoeken.",
      },
      {
        question: "Wat gebeurt er als de eerste kandidaten niet goed passen?",
        answer: "Je legt uit wat wel en niet past. Scout gebruikt die feedback om verder te zoeken en andere profielen te tonen.",
      },
      {
        question: "Welke informatie staat bij een kandidaat?",
        answer: "Je ziet relevante ervaring uit het profiel en welke belangrijke vragen nog openstaan.",
      },
      {
