...
const pageCopy: Record<Language, PageCopy> = {
  nl: {
    hero: {
      ...
      body: "Verminder handmatig werk zoals gegevens overnemen en kandidaten zoeken met software, AI en automatisering die aansluiten op je ATS, CRM en werkwijze. Zo werkt je team sneller en blijft er meer tijd over voor kandidaten en klanten.",
      primary: "Bespreek een proces",
      secondary: "Bekijk voorbeelden",
    },
    examples: {
      eyebrow: "WAAR PHILOO KAN HELPEN",
      title: "Minder tijd kwijt aan zoeken, overnemen en afstemmen.",
      body: "Standaardsoftware past niet op elk recruitmentproces. We bouwen voor stappen die nu nog onnodig veel tijd kosten.",
      cards: [
        { title: "Intake & opvolging", body: "Leg informatie één keer vast en houd afspraken, acties en terugkoppeling bij.", icon: ChatIcon },
        ...
        { title: "Documenten & gegevens", body: "Verwerk documenten en gegevens zonder dezelfde informatie steeds opnieuw over te nemen.", icon: FileCheckIcon },
        { title: "Planning & bezetting", body: "Houd planning en capaciteit inzichtelijk met minder handmatige afstemming.", icon: CalendarIcon },
      ],
    },
    systems: {
    ...
    approach: {
      ...
      steps: [
        ...
        { title: "We verbeteren stap voor stap", body: "Op basis van gebruik en feedback bepalen we welke stap daarna verder geautomatiseerd kan worden." },
      ],
    },
    cta: {
      title: "Welke stap in jullie proces kost nog onnodig veel tijd?",
  ...
  en: {
    hero: {
      ...
      body: "Reduce manual work with custom software, AI and automation that fit your ATS, CRM and recruitment process. This helps your team move faster and spend more time with candidates and clients.",
      primary: "Discuss a process",
      secondary: "View examples",
    },
    examples: {
      eyebrow: "WHERE PHILOO CAN HELP",
      title: "Spend less time on manual recruitment tasks.",
      body: "Not every recruitment process fits neatly into standard software. Philoo builds solutions for the parts of your process that still take too much manual effort.",
      cards: [
        ...
        { title: "Documents & data", body: "Handle documents and information without copying the same data more than once.", icon: FileCheckIcon },
    ...
    systems: {
      ...
      title: "Keep the systems you already use.",
      body: "Recruitment agencies already work with an ATS, CRM and other software. Philoo builds on those systems and fills the gaps where a process still requires too much manual work.",
    ...
    approach: {
      ...
      steps: [
        { title: "Choose one concrete process", body: "Together we identify where time is being lost and what a useful first improvement would be." },
        { title: "Build a first solution", body: "We create a working solution that fits your systems, data and way of working." },
        { title: "Improve step by step", body: "Use feedback to decide what to improve or automate next." },
      ],
    },
    cta: {
      title: "Where is manual work slowing down your process?",
      body: "Discuss it with Philoo. Together we can see whether custom software, AI or automation could help.",
