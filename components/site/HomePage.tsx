...
const homeCopy: Record<Language, {
  ...
  nl: {
    ...
    whyTitle: "Geef recruiters tijd voor het werk dat telt",
    whyBody: "Philoo helpt handmatig werk te verminderen, zodat recruiters sneller kunnen schakelen en meer tijd overhouden voor kandidaten, klanten en plaatsingen.",
  ...
  en: {
    ...
    intro: "Philoo builds software and AI for recruitment agencies that reduce manual work, help recruiters move faster and give them more time for candidates and clients.",
    routes: [
      { href: "/en/custom-software", title: "Custom software, AI & automation", body: "Reduce manual work in your recruitment process. Philoo builds solutions that fit the ATS, CRM and process you already use.", cta: "View custom software", accent: "green" },
      { href: "/en/cv-studio", badge: "Early access", title: "CV Studio", body: "Turn one candidate CV into the right version for your agency, client or tender.", cta: "View CV Studio", accent: "purple" },
    ...
    whyBody: "Philoo helps reduce manual work, so recruiters can move faster and spend more time with candidates, clients and placements.",
    ...
    <div className="site-page">
      ...
      <main>
        <section className="relative overflow-hidden border-b border-[#EDEEFA]" data-home-hero>
          ...
          <div className="relative mx-auto grid max-w-[1440px] gap-0 px-5 pb-4 pt-9 sm:px-8 sm:pb-7 sm:pt-11 lg:grid-cols-[minmax(0,1fr)_minmax(300px,0.68fr)] lg:items-center lg:gap-12 lg:px-10 lg:py-4 xl:gap-16">
            ...
            <div className="mx-auto mt-1 w-[min(34vw,128px)] min-w-0 lg:mt-0 lg:w-full lg:max-w-[320px]" data-home-hero-mark>
              <PhilooHeroMark />
            </div>
          </div>
        </section>

        <section aria-label={lang === "nl" ? "Oplossingen" : "Solutions"} className="mx-auto max-w-[1440px] px-5 py-5 sm:px-8 sm:py-7 lg:px-10 lg:py-4">
